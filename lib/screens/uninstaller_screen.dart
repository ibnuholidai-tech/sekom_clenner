...
class _UninstallerScreenState extends State<UninstallerScreen> {
  ...
  String _statusMessage =
      'Klik "Refresh" untuk memuat daftar aplikasi terinstal';
  ...
  void _initShortcuts() {
    final items = <_ShortcutItem>[
      ...
      _ShortcutItem(
        ...
        action: () =>
            SystemService.openSettingsUri('ms-settings:network-status'),
      ),
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    await Clipboard.setData(
                      ClipboardData(text: '${s.title}: ${s.description}'),
                    );
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        ...
                        child: Column(
                          ...
                          children: [
                            TextField(
                              ...
                              decoration: InputDecoration(
                                hintText:
                                    'Cari keyboard shortcut (keys/judul/kategori)...',
                                prefixIcon: Icon(Icons.search),
                      ...
                      Expanded(
                        child: _filteredKbShortcuts.isEmpty
                            ...
                            : GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return _buildKbShortcutCard(
                                    _filteredKbShortcuts[index],
                                  );
                                },
                              ),
                      ),
