...
class InstallableApplication {
  ...
  bool isSelected; // Made mutable for selection toggling

  // New fields for enhanced features
  final bool runAsAdmin;
  final bool silentInstall;
  final List<String> installArgs;
  final String fileType; // exe, msi, bat, cmd, ps1, etc.
  ...
  factory InstallableApplication.fromMap(Map<String, dynamic> map) {
    return InstallableApplication(
      ...
      runAsAdmin: map['runAsAdmin'] ?? false,
      silentInstall: map['silentInstall'] ?? false,
      installArgs: List<String>.from(map['installArgs'] ?? []),
  ...
  InstallableApplication copyWith({
    ...
    return InstallableApplication(
      ...
      installArgs: installArgs ?? this.installArgs,
